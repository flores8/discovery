...
#3
Discovery::Question.create(:question => 'Do you tend to be more', :option_1 => 'factual', :option_2 => 'speculative', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#4
Discovery::Question.create(:question => 'Do you like writers who', :option_1 => 'say what they mean', :option_2 => 'use metaphors and symblism', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#5
Discovery::Question.create(:question => 'Are you more', :option_1 => 'sensible', :option_2 => 'ideational', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#6
Discovery::Question.create(:question => 'Are you more interested in', :option_1 => 'what is actual', :option_2 => 'what is possible', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#7
Discovery::Question.create(:question => 'Facts', :option_1 => 'speak for themselves', :option_2 => 'illustrate principles', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#8
Discovery::Question.create(:question => 'Do you find visionaries and theorists', :option_1 => 'somewhat annoying', :option_2 => 'rather fascinating', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#9
Discovery::Question.create(:question => 'Common sense is', :option_1 => 'usually reliable', :option_2 => 'frequently questionable', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#10
...
#13
Discovery::Question.create(:question => 'Are you inclined to take what is said', :option_1 => 'more literally', :option_2 => 'more figuratively', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#14
Discovery::Question.create(:question => 'Do you more often see', :option_1 => 'what\'s right in front of you', :option_2 => 'what can only be imagined', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#15
Discovery::Question.create(:question => 'Are you more likely to trust', :option_1 => 'your experiences', :option_2 => 'your conceptions', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#16
Discovery::Question.create(:question => 'Are you more inclined to feel', :option_1 => 'down to earth', :option_2 => 'somewhat removed', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#17
Discovery::Question.create(:question => 'Do you prize in yourself', :option_1 => 'a strong hold on reality', :option_2 => 'a vivid imagination', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#18
Discovery::Question.create(:question => 'Are you drawn more to', :option_1 => 'fundamentals', :option_2 => 'overtones', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#19
Discovery::Question.create(:question => 'In stories do you prefer', :option_1 => 'action and adventure', :option_2 => 'fantasy and heroism', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
#20
Discovery::Question.create(:question => 'Is it easier for you to', :option_1 => 'put others to good use', :option_2 => 'identify with others', :personality_type => "Sensory/Intuitive", :option_1_value => 'Sensory', :option_2_value => 'Intuitive')
